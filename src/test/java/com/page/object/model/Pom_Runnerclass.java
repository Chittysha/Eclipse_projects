...
public class Pom_Runnerclass extends Base_Class {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		send_Keys(manager.getLogin().getEmail(), "chittyrose");
		send_Keys(manager.getLogin().getPassword(), "251999");
...
//		send_Keys(manager.getSearch().getCheck_In(), "25/11/2022");
//		send_Keys(manager.getSearch().getCheck_Out(), "30/11/2022");
...
//
//		send_Keys(manager.getBook().getFirst_Name(), "Rose");
//		send_Keys(manager.getBook().getLast_Name(), "Chloe");
//		send_Keys(manager.getBook().getAddress(), "No.2,icecream road,london");
...
//		send_Keys(manager.getBook().getCvv_Number(), "434");
//		Click(manager.getBook().getBook_Now_Btn());
//
//		Scrollup(manager.getConfirm().getConfirm());
//		takes_screen(manager.getConfirm().getConfirm());
//
	}
